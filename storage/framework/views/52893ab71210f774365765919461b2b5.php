    ...
    <div class="sidebar-inner px-3 pt-5 d-flex flex-column justify-content-between" style="height:100vh;">
        ...
        <div>
            ...
            <ul class="nav flex-column">
                ...
                <!-- Riwayat Transaksi -->
                <li class="nav-item">
                    <a href="<?php echo e(route('transaksi.riwayat')); ?>"
                       class="nav-link d-flex align-items-center mb-2"
                       style="padding: 10px 15px; <?php echo e(request()->is('transaksi*') ? 'background:#D35400;color:white;border-radius:10px;' : 'color:#5A3E2B;'); ?>">
                        <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width:20px;">
...
</nav><?php /**PATH C:\laragon\www\pelanidimsum\resources\views/layouts/admin/sidebar.blade.php ENDPATH**/ ?>