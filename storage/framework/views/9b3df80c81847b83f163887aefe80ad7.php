    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-7 text-center text-lg-start">
                ...
                <form action="<?php echo e(route('home.index')); ?>" method="GET" class="d-flex bg-white shadow-sm rounded-pill p-2" style="max-width: 450px;">
                    <input class="form-control border-0 ps-4" type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari menu...">
                    <button class="btn btn-orange">Cari</button>
                </form>
            </div>

            <div class="col-lg-5 d-none d-lg-block text-center">
                <img src="<?php echo e(asset('assets-admin/img/dimsum1.jpg')); ?>" class="standard-img rounded-circle" alt="Hero">
            </div>
        </div>
    </div>
</div>
...
<div id="about" class="container py-5">
    <div class="row g-5 align-items-center">
        <div class="col-lg-5 text-center">
            <img src="<?php echo e(asset('assets-admin/img/dimsum3.jpg')); ?>" class="standard-img rounded-4" alt="About">
        </div>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="card product-card shadow-sm h-100">
                    <div class="position-relative">
                        <img src="<?php echo e(asset('gambar_product/' . $item->gambar_product)); ?>"
                             class="card-img-top" style="height:220px; object-fit:cover;" alt="<?php echo e($item->nama_produk); ?>">
                        <div class="price-tag">Rp <?php echo e(number_format($item->harga, 0, ',', '.')); ?></div>
                    </div>
                    <div class="card-body p-4 text-center">
                        <h6 class="fw-bold mb-2"><?php echo e($item->nama_produk); ?></h6>
                        <p class="small text-muted mb-3"><?php echo e(\Illuminate\Support\Str::limit($item->deskripsi, 50)); ?></p>
                        <a href="<?php echo e(route('produk.show_detail', $item->produk_id)); ?>"
            ...
            <div class="col-12 text-center py-5">
                <p class="content-text">Maaf, menu "<?php echo e(request('search')); ?>" tidak ditemukan.</p>
                <a href="<?php echo e(route('home.index')); ?>" class="btn btn-orange">Lihat Semua Menu</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\pelanidimsum\pelanidimsum\resources\views/home.blade.php ENDPATH**/ ?>