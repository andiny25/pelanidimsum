            ...
            <div class="card shadow-sm border-start border-4 border-warning">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e($contacts->count()); ?></h2>
        ...
        <div class="col-xl-8">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                    ...
                    <a href="<?php echo e(route('produk.list')); ?>" class="btn btn-sm btn-outline-warning fw-bold">
                        Lihat Semua
                    </a>
                </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="fw-bold text-dark"><?php echo e($item->name_produk); ?></td>
                                    <td class="text-pelani fw-bold">Rp <?php echo e(number_format($item->harga ?? 0, 0, ',', '.')); ?>

                                    </td>
                                    <td class="text-center">
                                        <img src="<?php echo e(asset('gambar_product/' . $item->gambar_product)); ?>" width="55"
                    ...
                    <table class="table table-hover align-items-center mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="ps-4 fw-bold text-muted"><?php echo e($loop->iteration); ?></td>
                                    <td class="fw-bold text-dark"><?php echo e($contact->name); ?></td>
                                    <td class="small text-muted text-nowrap"><?php echo e($contact->email); ?></td>
                                    <td>
                                        <span class="subject-badge">
                                            <?php echo e($contact->subject ?? 'No Subject'); ?>
        ...
        <div class="col-xl-4">
            ...
            <div class="card shadow-sm mb-4 text-center overflow-hidden">
                ...
                <div class="card-body pt-0">
                    <img src="<?php echo e(asset('assets-admin/img/dimsum1.jpg')); ?>"
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <?php $__empty_1 = true; $__currentLoopData = $pelangganTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="p-3 rounded-3 mb-3 border-start border-4 border-warning shadow-sm"
                            style="background-color: #fcfcfc;">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <h6 class="mb-0 fw-bold text-dark" style="font-size: 0.9rem;"><?php echo e($p->first_name); ?>

                                    </h6>
                                    <small class="text-muted" style="font-size: 0.75rem;"><?php echo e($p->email); ?></small>
                                </div>
                                <span
                                    class="badge-date shadow-sm"><?php echo e(\Carbon\Carbon::parse($p->created_at)->format('d M Y')); ?></span>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\pelanidimsum\pelanidimsum\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>