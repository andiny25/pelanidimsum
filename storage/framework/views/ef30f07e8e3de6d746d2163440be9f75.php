        ...
        <div class="col-lg-10">
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb small bg-transparent p-0">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('home.index')); ?>" class="text-muted text-decoration-none">Beranda</a></li>
                    <li class="breadcrumb-item active text-orange fw-600" aria-current="page"><?php echo e($item->name_produk); ?></li>
                </ol>
            </nav>
                ...
                <div class="row g-0">
                    <div class="col-md-5">
                        <div class="position-relative h-100">
                            <img src="<?php echo e(asset('gambar_product/' . $item->gambar_product)); ?>"
                                 ...
                                 alt="<?php echo e($item->name_produk); ?>"
                    ...
                    <div class="col-md-7">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <h2 class="fw-700 mb-2 text-dark"><?php echo e($item->name_produk); ?></h2>

                            <div class="d-flex align-items-baseline mb-4">
                                <h3 class="text-orange fw-700 mb-0">Rp <?php echo e(number_format($item->harga, 0, ',', '.')); ?></h3>
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-8">
                                    <a href="https://wa.me/6281234567890?text=Halo%20Pelani%20Dimsum,%20saya%20ingin%20memesan%20<?php echo e(urlencode($item->name_produk)); ?>"
                                       target="_blank"
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('home.index')); ?>" class="text-muted small text-decoration-none hover-orange">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\pelanidimsum\pelanidimsum\resources\views/detail_produk.blade.php ENDPATH**/ ?>