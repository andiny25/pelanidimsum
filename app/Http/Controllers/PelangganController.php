...
class PelangganController extends Controller
{
    ...
    {
        $filterableColums = ['gender', 'birthday'];
        $searchableColumns = ['first_name', 'last_name'];
        $pageData['dataPelanggan'] = Pelanggan::filter($request, $filterableColums, $searchableColumns)->paginate(5)->OnEachSide(2)->withQueryString();
