...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets-frontend/lib/lightbox/css/lightbox.min.css') }}">
            ...
            <nav class="navbar navbar-expand-xl navbar-light bg-white py-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="{{ route('login') }}" class="btn px-4 py-2 text-white shadow-sm"
    ...
    <footer class="container-fluid footer pt-4 pb-1">
        <div class="container py-4">
            ...
            <div class="text-center text-white-50 small mt-0 pb-1">
                &copy; {{ date('Y') }} <strong>Pelani Dimsum</strong>. All Rights Reserved.
            </div>
        </div>
    </footer>
