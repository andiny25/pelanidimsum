    ...
    <div class="pos-container">
        <div class="menu-section custom-scroll">
            <div class="row g-4" id="produk-list">
                ...
                <div class="col-md-6 col-xl-4 produk-item" data-nama="{{ strtolower($item->name_produk) }}">
                    <div class="card menu-card shadow-sm h-100">
                        <div class="menu-img-wrapper">
                            <img src="{{ asset('gambar_product/' . $item->gambar_product) }}" onerror="this.src='https://placehold.co/400x300?text=Menu';">
                            <div class="price-tag shadow-sm">Rp{{ number_format($item->harga, 0, ',', '.') }}</div>
                        </div>
                        <div class="card-body p-4">
                            <h5 class="fw-bold text-dark mb-3">{{ $item->name_produk }}</h5>
                            <button class="btn btn-add-menu shadow-sm" onclick="tambahKeranjang({{ $item->produk_id }}, '{{ $item->name_produk }}', {{ $item->harga }})">
