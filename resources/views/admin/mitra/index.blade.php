...
@section('content')
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <p class="mb-0">List data Mitra </p>
                                    ...
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            <div class="input-group">
                                                ...
                                                @if (request('search'))
                                                    <a href="{{ url()->current()}}" class="btn btn-outline-secondary ml-3"id="clear-search">Clear</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($dataMitra as $m)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-{{ $m->jenis_kemitraan == 'Platinum' ? 'info' : ($m->jenis_kemitraan == 'Gold' ? 'warning' : 'secondary') }}">
                                                    {{ $m->jenis_kemitraan }}
                                                </span>
                                            </td>
                                            <td>{{ date('d-M-Y', strtotime($m->tanggal_bergabung)) }}</td>
                                            <td>
                                                <a href="{{ route('mitra.edit', $m->mitra_id) }}"
